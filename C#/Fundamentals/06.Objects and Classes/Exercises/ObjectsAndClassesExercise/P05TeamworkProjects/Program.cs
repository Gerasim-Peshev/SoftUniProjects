    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (line != "end of assignment")
            {
                ...
                {
                    var curentTeam = teams.First(team => team.Name == teamToJoin);
                    curentTeam.Members.Add(user);
                }
            ...
            foreach (Team team in finalTeams.OrderByDescending(team => team.Members.Count).ThenBy(team => team.Name))
            {
                ...
                foreach (string teamMember in team.Members.OrderBy(member => member))
                {
